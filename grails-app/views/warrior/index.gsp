			...
			<div id="content">
				...
				<ul style="font-size:12px;list-style-type:none;">
					<g:each in="${journal}"  var="je">
						...
						<g:if test="${je.type == 1}">
							<li><label style="color:#555555"><g:dateFromNow date="${je.dateCreated}"/>.</label> <i>While exploring you encountered ${je.encounter.description}. You <b><g:if test="${je.won}">won</g:if><g:else>lost</g:else></b> the fight. 
