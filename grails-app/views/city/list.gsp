                ...
                <table>
                    <thead>
                        <tr>
                            ...
                            <th><g:message code="city.stats.label" default="Stats" /></th>
                        
                            <th><g:message code="city.map.label" default="Map" /></th>
                    ...
                    <g:each in="${cityInstanceList}" status="i" var="cityInstance">
                        <tr class="${(i % 2) == 0 ? 'odd' : 'even'}">
                            ...
                            <td>${fieldValue(bean: cityInstance, field: "stats")}</td>
                        
                            <td>${fieldValue(bean: cityInstance, field: "map")}</td>
