...
//		println "\tBARBARIAN"
		def barbarian_base_stats = new StatsList(HP:250,STA:80,STR:5,CON:3,DEX:2,AGI:1)
		def barbarian_levelup_stats = new StatsList(HP:50,STA:15,STR:2,CON:1,DEX:0,AGI:0)
...
//		println "\tSOLDIER"
		def soldier_base_stats = new StatsList(HP:400,STA:50,CON:5,STR:3,AGI:2,DEX:1)
		def soldier_levelup_stats = new StatsList(HP:75,STA:10,CON:2,STR:1,AGI:0,DEX:0)
